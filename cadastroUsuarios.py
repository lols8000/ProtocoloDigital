...
def cadastrarUsuario():
    ...
    # Botão atualizar
    b_atualizar = Button(frame_baixo, command=atualizar, text='Atualizar', width='10', font=('Ivy 9 bold'), bg=co2,
                         fg=co1,
                         relief='raised', overrelief='ridge')
    b_atualizar.place(x=110, y=340)

    # Botão Deletar
    b_deletar = Button(frame_baixo, command=deletar, text='Deletar', width='10', font=('Ivy 9 bold'), bg=co7, fg=co1,
                       relief='raised',
                       overrelief='ridge')
